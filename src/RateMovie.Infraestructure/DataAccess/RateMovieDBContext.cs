        ...
        private void EntityBuilderMovieSeed(EntityTypeBuilder<Movie> entity)
        {
            entity.HasData(
                 new Movie
                 {
                     Id = 1,
                     Name = "Parasite",
                     Comment = "A masterful blend of thriller, dark comedy, and social commentary. Bong Joon-ho's film is a razor-sharp look at class inequality, told through the story of two families from different ends of the economic spectrum. The plot is full of unpredictable twists and turns that keep you on the edge of your seat, culminating in a shocking and thought-provoking climax. The performances are outstanding, and the direction is impeccable, making every scene a study in tension and satire. It’s a compelling, multi-layered film that resonates long after the credits roll, cementing its place as a modern cinematic classic.",
                     Stars = 5
                 },
                new Movie
                {
                ...
                new Movie
                {
                    Id = 10,
                    Name = "1917",
                    Comment = "A breathtaking and immersive war film that feels like a single, continuous shot. Sam Mendes' direction is a stunning technical achievement, putting you directly in the shoes of two young British soldiers on a perilous mission. The sense of urgency and danger is palpable throughout the entire film. The cinematography is masterful, with sweeping, fluid camera movements that highlight the desolate and dangerous landscapes of the Western Front. It's a visceral, emotional, and harrowing portrayal of the senselessness of war, focusing on the human cost rather than grand strategy. A technical tour de force that is as impressive as it is moving.",
                    Stars = 4
                },
                new Movie
                {
                ...
                new Movie
                {
                    Id = 19,
                    Name = "Suicide Squad",
                    Comment = "A chaotic and tonally inconsistent superhero film that struggles to find its identity. While it features a fun, charismatic cast, particularly Margot Robbie as Harley Quinn, the movie is let down by a weak villain and a disjointed narrative. The reshoots and studio interference are evident, resulting in a confusing story that jumps from scene to scene without a clear flow. The promise of an edgy, R-rated anti-hero film was replaced with a generic, sanitized action movie. It has some flashy moments and a great soundtrack, but ultimately feels like a wasted opportunity to explore a darker side of the DC universe.",
                    Stars = 2
                },
                new Movie
                {
