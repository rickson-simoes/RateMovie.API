        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 14, "The movie is interesting because it presents a vampire who, instead of killing, seeks a way to feed voluntarily, finding people who are willing to die for a cause. This approach subverts the cliché of the bloodthirsty vampire and makes us reflect on morality and the need for survival.", "Humanistic Vampire Seeking Consenting Suicidal Person", (sbyte)3 },
